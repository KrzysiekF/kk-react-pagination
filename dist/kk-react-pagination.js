...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = setPageAction;
/* harmony export (immutable) */ __webpack_exports__["b"] = setPagesCountAction;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__types__ = __webpack_require__(36);


function setPageAction(page, pagerName) {
    return {
        type: __WEBPACK_IMPORTED_MODULE_0__types__["a" /* SET_PAGE */],
        name: pagerName,
...
function setPagesCountAction(count, pagerName) {
    return {
        type: __WEBPACK_IMPORTED_MODULE_0__types__["b" /* SET_PAGES_COUNT */],
        name: pagerName,
...
var PagerCalc = function () {
    ...
    _createClass(PagerCalc, null, [{
        key: "pagesCount",
        value: function pagesCount(elementsCount, pageSize) {
            return Math.ceil(elementsCount / pageSize);
        }
    }, {
        key: "calcStartRange",
        value: function calcStartRange(currentPage, pageSize) {
            return (currentPage - 1) * pageSize + 1;
        }
    }, {
        key: "calcEndRange",
        value: function calcEndRange(currentPage, pageSize) {
            return currentPage * pageSize;
        }
    }, {
        key: "canDisplayElement",
        value: function canDisplayElement(key, currentPage, pageSize) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pagination_calculations__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pagination_actions__ = __webpack_require__(32);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Pagination = function (_Component) {
    ...
    _createClass(Pagination, [{
        ...
        value: function componentWillMount() {
            ...
            this.props.setPagesCountAction(__WEBPACK_IMPORTED_MODULE_2__pagination_calculations__["a" /* default */].pagesCount(this.props.children.length, this.props.pageSize), this.props.name);
        }
    }, {
        key: 'prevPage',
        ...
        value: function renderPaginator() {
            ...
            var buttons = function buttons() {
                ...
                var _loop = function _loop(i) {
                    buttons.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'button',
                        { className: '' + (i === _this2.props.paginator.currentPage ? 'active' : ''), key: i, onClick: function onClick() {
                                _this2.changePage(i);
                            } },
                        i
                    ));
                ...
                for (var i = 1; i <= _this2.props.paginator.pagesCount; i++) {
                    _loop(i);
                }
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'button',
                    { onClick: this.prevPage, disabled: this.props.paginator.currentPage <= 1 },
                    'prev'
                ),
                buttons(),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'button',
                    { onClick: this.nextPage, disabled: this.props.paginator.currentPage >= this.props.paginator.pagesCount },
                    'next'
                )
            );
        }
        ...
        value: function render() {
            ...
            var elements = this.props.children.map(function (element, key) {
                return __WEBPACK_IMPORTED_MODULE_2__pagination_calculations__["a" /* default */].canDisplayElement(key, _this3.props.paginator.currentPage, _this3.props.pageSize) ? element : '';
            });
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_redux__["a" /* connect */])(mapStateToProps, { setPageAction: __WEBPACK_IMPORTED_MODULE_3__pagination_actions__["a" /* setPageAction */], setPagesCountAction: __WEBPACK_IMPORTED_MODULE_3__pagination_actions__["b" /* setPagesCountAction */] })(Pagination));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SET_PAGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return SET_PAGES_COUNT; });
...
var ReactPureComponent = __webpack_require__(67);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(31), __webpack_require__(79)(module)))
